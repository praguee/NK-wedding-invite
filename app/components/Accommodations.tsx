    ...
    <div className="flex gap-0.5 items-center">
      {[1, 2, 3, 4].map((i) => (
        <span
          ...
          style={{
            background: i <= count ? '#C49A28' : 'rgba(196,154,40,0.18)',
          }}
        />
      ))}
    </div>
        ...
        <div className="glass-gold rounded-2xl overflow-hidden divide-y" style={{ borderColor: 'rgba(196,154,40,0.1)' }}>
          {HOTELS.map((hotel) => (
            <a
              ...
              className="hotel-row flex items-center justify-between px-5 py-4 transition-colors"
            >
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  <MapPin size={11} style={{ color: '#C4B09A', flexShrink: 0 }} />
              ...
              <div className="flex items-center gap-3 ml-4 flex-shrink-0">
                ...
                <ExternalLink size={13} style={{ color: '#C4B09A' }} />
              </div>
            </a>
          ))}
        </div>
